...
const services = [
  {
    ...
    description: "Comprehensive cleaning services for your home, ensuring a spotless and healthy living space.",
  },
  {
  ...
  },
  {
    ...
    title: "Deep Cleaning",
    description: "Thorough, top-to-bottom cleaning for a truly immaculate environment.",
  },
  {
    icon: <Sun className="w-10 h-10 text-primary mb-4" />,
    title: "Window Cleaning",
    description: "Streak-free window cleaning for sparkling clear views, inside and out.",
  },
  {
  ...
  },
  {
    ...
    description: "Reliable solutions for minor repairs and maintenance tasks around your property.",
  },
]
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollRevealWrapper animationType="fadeInUp" delay={0.1}>
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              We provide a wide range of cleaning and maintenance solutions to meet your every need.
            </p>
          </div>
        </ScrollRevealWrapper>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            >
              <Card className="text-center h-full transform transition-all duration-300 ease-in-out hover:shadow-xl hover:-translate-y-1">
                <CardHeader>
